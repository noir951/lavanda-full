		...
		var 
			...
			$(document).ready(function() {
				if ($(window).width() <= 576) {
					...
					(function(){
var a = document.querySelector('.oreder-list-check-fix'), b = 1, P = 30;  // если ноль заменить на число, то блок будет прилипать до того, как верхний край окна браузера дойдёт до верхнего края элемента. Может быть отрицательным числом
